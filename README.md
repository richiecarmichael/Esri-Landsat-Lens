...
Click [here](http://maps.esri.com/rc/landsat/index.html) or [here](http://richiecarmichael.github.io/landsat/index.html) to view the live application. The preset bookmarks are inspired by [this](http://earthobservatory.nasa.gov/Features/WorldOfChange/) NASA article.
